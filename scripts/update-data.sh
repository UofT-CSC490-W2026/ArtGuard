...
def find_local_file(
    ...
    Strategy:
      1) If image_name is a relative path like Train/class 1/foo.jpg, use exact match.
      2) Otherwise fall back to basename lookup across the full data tree.
    ...
    # Exact relative-path match under DATA_DIR
