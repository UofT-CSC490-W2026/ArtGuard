...
vi.mock("@/app/pages/HomePage", () => ({ HomePage: () => <div data-testid="home-page" /> }));
vi.mock("@/app/pages/SignUpPage", () => ({ SignUpPage: () => <div data-testid="signup-page" /> }));
vi.mock("@/app/pages/LoginPage", () => ({ LoginPage: () => <div data-testid="login-page" /> }));
vi.mock("@/app/pages/UploadPage", () => ({ UploadPage: () => <div data-testid="upload-page" /> }));
vi.mock("@/app/pages/ResultsPage", () => ({ ResultsPage: () => <div data-testid="results-page" /> }));
vi.mock("@/app/pages/HistoryPage", () => ({ HistoryPage: () => <div data-testid="history-page" /> }));
vi.mock("@/app/pages/ProfilePage", () => ({ ProfilePage: () => <div data-testid="profile-page" /> }));
vi.mock("@/app/components/RootLayout", () => ({
  RootLayout: () => (
